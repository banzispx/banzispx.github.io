...
[flex 详解](https://www.ruanyifeng.com/blog/2015/07/flex-grammar.html)
...
1. 根元素，即html
2. float的值不为none（默认） left  right  inherit 
3. overflow的值不为visible（默认）  hidden  scroll  auto  inherit 
...
## 层叠上下文
 ...
 <img :src="$withBase('/css/zindex.png')" alt="jiami">
